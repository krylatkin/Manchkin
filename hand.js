...
(function (App) {
    ...
    function Hand (player){
        App.Card.apply(this, arguments); // Вызываем конструктор родителя с такими же параметрами
    ...
    Hand.prototype = Object.create(App.Card.prototype); // Правильное наследование! Копирует методы из прототипа
